...
\foreach \x in {1,...,27}{%
    ...
    % \node[anchor=north] (single) at ([shift={(0,0)}]perf.south) {\includegraphics[trim=0mm 0mm 0mm 0mm, clip, width=0.49\linewidth]{figs/lesion \x/single_unit_activations.pdf}};
