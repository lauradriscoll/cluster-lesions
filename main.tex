...
\foreach \x in {2,4,6}{%
    ...
    \node[anchor=north] (pop) at ([shift={(1.5,0)}]hdiff.south) {\includegraphics[trim=30mm 80mm 40mm 80mm, clip,width=0.35\linewidth]{figs/lesion \x/population_compare.pdf}};
    \node[anchor=north] (pccontribution) at ([shift={(-2,0)}]pop.south) {\includegraphics[trim=0mm 0mm 0mm 0mm, clip,width=0.65\linewidth]{figs/lesion \x/pc_contribution.pdf}};
    \end{tikzpicture}
    \end{figure}
    \pagebreak
}
